...
#                                                    ifelse(sample_data(mis.noBulk)$Year=="2017","2")))
...
```{r abundance-occupancy-plot}
mis.noBulk.2015.re <- prune_samples(sample_data(mischanthus.noBulk.relative)$Year =="2015", mischanthus.noBulk.relative)
mis.noBulk.2016.re <- prune_samples(sample_data(mischanthus.noBulk.relative)$Year =="2016", mischanthus.noBulk.relative)
mis.noBulk.2017.re <- prune_samples(sample_data(mischanthus.noBulk.relative)$Year =="2017", mischanthus.noBulk.relative)
mis.noBulk.2015.re.abund.occu <- mefa::aoplot(mis.noBulk.2015.re, )
```
